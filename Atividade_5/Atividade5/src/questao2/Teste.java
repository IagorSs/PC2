...
public class Teste {
    public static void main(String[] args) {
        ...
        HashMap <String, Contato> contatosIniciais = new HashMap();
        contatosIniciais.put(a.getNome(), a);
        contatosIniciais.put(b.getNome(), b);
        contatosIniciais.put(c.getNome(), c);
        agenda.setAgenda(contatosIniciais);
        ...
        System.out.println("\n\nAgenda final\n");
        System.out.printf("%s", agenda.exibeAgenda());
